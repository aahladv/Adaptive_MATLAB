...
xlabel('time')
legend('system1','system2','system3','system4');
Location('Best');
...
K        = 10   ; %Enter a number
a1       = 0.5    ; %Enter a number
a2       = 0.5;
v = [700 0.5 0.5 120 0.5];
gamma    = diag(v);
beta     = 0.9;
...
thetaHatDot = [0.65*tanh(e2(1)+e2(2)); 0.000025*tanh(e2(1)+e2(2)); tanh(e2(1)+e2(2)); tanh(e2(1)+e2(2)); tanh(e2(1)+e2(2))];
